    ...
    <nav class="navbar navbar-expand-lg main_menu">
        <div class="container">
            <a class="navbar-brand" href="index.html">
                <img src="{{ asset('front/images/logo.png') }}" alt="DB.Card">
            </a>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-sm-6">
                        <a href="#" class="wsus__category_single">
                            <div class="wsus__category_img">
                                <img src="{{ asset('frontend/images/user_small.jpg') }}" alt="img"
                                    class="img-fluid w-100">
                            </div>
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <a href="#" class="wsus__category_single">
                            <div class="wsus__category_img">
                                <img src="{{ asset('frontend/images/user_small2.jpg') }}" alt="img"
                                    class="img-fluid w-100">
                            </div>
                            <div class="wsus__category_text">
                                <div class="wsus__category_text_center">
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <a href="#" class="wsus__category_single">
                            <div class="wsus__category_img">
                                <img src="asset{{ 'frontend/images/user_small3.jpg' }}" alt="img"
                                    class="img-fluid w-100">
                            </div>
                            <div class="wsus__category_text">
                                <div class="wsus__category_text_center">
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <a href="#" class="wsus__category_single">
                            <div class="wsus__category_img">
                                <img src="{{ asset('frontend/images/user_small5.jpg') }}" alt="img"
                                    class="img-fluid w-100">
                            </div>
                            <div class="wsus__category_text">
                                <div class="wsus__category_text_center">
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <a href="#" class="wsus__category_single">
                            <div class="wsus__category_img">
                                <img src="{{ asset('frontend/images/user_small4.jpg') }}" alt="img"
                                    class="img-fluid w-100">
                            </div>
                            <div class="wsus__category_text">
                                <div class="wsus__category_text_center">
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <a href="#" class="wsus__category_single">
                            <div class="wsus__category_img">
                                <img src="{{ asset('frontend/images/user_small6.jpg') }}" alt="img"
                                    class="img-fluid w-100">
                            </div>
                            <div class="wsus__category_text">
                                <div class="wsus__category_text_center">
                ...
                <div class="row grid">
                    <div class="col-xl-3 col-sm-6 col-lg-4 newyork hongkong tokyo">
                        <a href="#" class="wsus__single_location">
                            <div class="img">
                                <img src="{{ asset('frontend/images/location_1.jpg') }}" alt="location"
                                    class="img-fluid w-100">
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-lg-4 london parish moscow">
                        <a href="#" class="wsus__single_location">
                            <div class="img">
                                <img src="{{ asset('frontend/images/location_2.jpg') }}" alt="location"
                                    class="img-fluid w-100">
                            </div>
                            <div class="wsus__location_text">
                                <p>thailand</p>
                    ...
                    <div class="col-xl-3 col-sm-6 col-lg-4 newyork hongkong tokyo">
                        <a href="#" class="wsus__single_location">
                            <div class="img">
                                <img src="{{ asset('frontend/images/location_3.jpg') }}" alt="location"
                                    class="img-fluid w-100">
                            </div>
                            <div class="wsus__location_text">
                                <p>parish</p>
                    ...
                    <div class="col-xl-3 col-sm-6 col-lg-4 london parish moscow">
                        <a href="#" class="wsus__single_location">
                            <div class="img">
                                <img src="{{ asset('frontend/images/location_7.jpg') }}" alt="location"
                                    class="img-fluid w-100">
                            </div>
                            <div class="wsus__location_text">
                                <p>singapore</p>
                    ...
                    <div class="col-xl-3 col-sm-6 col-lg-4 london hongkong moscow">
                        <a href="#" class="wsus__single_location">
                            <div class="img">
                                <img src="{{ asset('frontend/images/location_4.jpg') }}" alt="location"
                                    class="img-fluid w-100">
                            </div>
                            <div class="wsus__location_text">
                                <p>japan</p>
                    ...
                    <div class="col-xl-3 col-sm-6 col-lg-4 newyork parish tokyo">
                        <a href="#" class="wsus__single_location">
                            <div class="img">
                                <img src="{{ asset('frontend/images/location_5.jpg') }}" alt="location"
                                    class="img-fluid w-100">
                            </div>
                            <div class="wsus__location_text">
                                <p>korea</p>
                    ...
                    <div class="col-xl-3 col-sm-6 col-lg-4 london parish moscow">
                        <a href="#" class="wsus__single_location">
                            <div class="img">
                                <img src="{{ asset('frontend/images/location_6.jpg') }}" alt="location"
                                    class="img-fluid w-100">
                            </div>
                            <div class="wsus__location_text">
                                <p>singapore</p>
                    ...
                    <div class="col-xl-3 col-sm-6 col-lg-4 london parish moscow">
                        <a href="#" class="wsus__single_location">
                            <div class="img">
                                <img src="{{ asset('frontend/images/location_8.jpg') }}" alt="location"
                                    class="img-fluid w-100">
                            </div>
                            <div class="wsus__location_text">
                                <p>singapore</p>
        ...
        <div class="container">
            <div class="row listing_slider">
                <div class="col-xl-3">
                    <div class="wsus__featured_single">
                        <div class="wsus__featured_single_img">
                            <img src="{{ asset('frontend/images/location_1.jpg') }}" alt="images"
                                class="img-fluid w-100">
                ...
                <div class="col-xl-3">
                    <div class="wsus__featured_single">
                        <div class="wsus__featured_single_img">
                            <img src="{{ asset('frontend/images/location_2.jpg') }}" alt="images"
                                class="img-fluid w-100">
                            <a href="#" class="love"><i class="fas fa-heart"></i></a>
                ...
                <div class="col-xl-3">
                    <div class="wsus__featured_single">
                        <div class="wsus__featured_single_img">
                            <img src="{{ asset('frontend/images/location_3.jpg') }}" alt="images"
                                class="img-fluid w-100">
                            <a href="#" class="love"><i class="fas fa-heart"></i></a>
                ...
                <div class="col-xl-3">
                    <div class="wsus__featured_single">
                        <div class="wsus__featured_single_img">
                            <img src="{{ asset('frontend/images/location_4.jpg') }}" alt="images"
                                class="img-fluid w-100">
                            <a href="#" class="love"><i class="fas fa-heart"></i></a>
                ...
                <div class="col-xl-3">
                    <div class="wsus__featured_single">
                        <div class="wsus__featured_single_img">
                            <img src="{{ asset('frontend/images/location_5.jpg') }}" alt="images"
                                class="img-fluid w-100">
                            <a href="#" class="love"><i class="fas fa-heart"></i></a>
                            ...
                            <div class="col-12 col-xl-12 col-md-12">
                                <div class="map_popup_content">
                                    ...
                                    <div class="map_popup_text">
                                        ...
                                        <a class="call" href="callto:+69552200325444"><i
                                                class="fal fa-phone-alt"></i>
                                            +69552200325444</a>
                                        <a class="mail" href="mailto:example@gmail.com"><i
                ...
                <div class="row testi_slider">
                    <div class="col-xl-6">
                        <div class="wsus__single_clients">
                            <div class="text">
                                <img src="{{ asset('frontend/images/team-2.jpg') }}" alt="clients"
                                    class="img-fluid">
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-lg-4">
                        <div class="single_blog">
                            <div class="img">
                                <img src="{{ asset('frontend/images/blog_1.jpg') }}" alt="bloh images"
                                    class="img-fluid w-100">
                            </div>
                            <div class="text">
                    ...
                    <div class="col-xl-4 col-md-6 col-lg-4">
                        <div class="single_blog">
                            <div class="img">
                                <img src="{{ asset('frontend/images/blog_2.jpg') }}" alt="bloh images"
                                    class="img-fluid w-100">
                            </div>
                            <div class="text">
                    ...
                    <div class="col-xl-4 col-md-6 col-lg-4">
                        <div class="single_blog">
                            <div class="img">
                                <img src="{{ asset('frontend/images/blog_3.jpg') }}" alt="bloh images"
                                    class="img-fluid w-100">
                            </div>
                            <div class="text">
                                <span><i class="fal fa-calendar-alt"></i> 05 Julay 2021</span>
